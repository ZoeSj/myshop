...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link href="/my/myshop/Home/Public/css/style.css" rel="stylesheet" type="text/css" />

    </head>
    <body class="index_body">
        <div class="block clearfix" style="position: relative; height: 98px;">
            <a href="#" name="top"><img class="logo" src="/my/myshop/Home/Public/img/logo.gif"></a>
        ...
        <div class="header_bg">
            ...
            <form id="searchForm" method="get" action="#">
                ...
                <input name="imageField" value=" " class="go" style="cursor: pointer; background: url('/my/myshop/Home/Public/img/sousuo.gif') no-repeat scroll 0% 0% transparent; width: 39px; height: 20px; border: medium none; float: left; margin-right: 15px; vertical-align: middle;" type="submit" />
        ...
        <div class="header_bg_b">
            <div class="f_l" style="padding-left: 10px;">
                <img src="/my/myshop/Home/Public/img/biao6.gif" />
                北京市区，现在下单(截至次日00:30已出库)，<b>明天上午(9-14点)</b>送达 <b>免运费火热进行中！</b>

            </div>
            <div class="f_r" style="padding-right: 10px;">
                <img style="vertical-align: middle;" src="/my/myshop/Home/Public/img/biao3.gif">
                    <span class="cart" id="ECS_CARTINFO">
                        <a href="#" title="查看购物车">您的购物车中有 0 件商品，总计金额 ￥0.00元。</a></span>
                    <a href="#"><img style="vertical-align: middle;" src="/my/myshop/Home/Public/img/biao7.gif"></a>
        ...
        <div class="blank"></div>
        <div class="block">
            <a href="#" target="_blank" title="YONGDA商城"><img alt="YONGDA商城" src="/my/myshop/Home/Public/img/di.jpg"></a>
            <div class="blank"></div>
        </div>
        ...
        <div id="bottomNav" class="box block">
            <div class="box_1">
                <div class="links clearfix"> 
                    <a href="#" target="_blank" title="YONGDA商城"><img src="/my/myshop/Home/Public/img/ecmoban_link.jpg" alt="YONGDA商城" border="0"></a>

                    <a href="#" target="_blank" title="YONGDA 网上商店管理系统">
                        <img src="/my/myshop/Home/Public/img/yongda_logo.gif" alt="YONGDA 网上商店管理系统" border="0" />
                    </a>
